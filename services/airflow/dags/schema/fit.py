...
PROGRAM_SEMESTER = {
    ...
    "schema": [
        {"name": "program_semester_id", "type": "STRING", "primary_key": True},
...
INSTRUCTION = {
    ...
    "schema": [
        ...
        {"name": "program_semester_id", "type": "STRING"},
...
INSTRUCTION_LECTURER = {
    ...
    "foreign_key": [
        {"column": "instruction_id", "reference": {"table": "instruction", "column": "instruction_id"}},
...
ENROLL_STUDENT = {
    ...
    "foreign_key": [
        ...
        {"column": "enrollment_id", "reference": {"table": "enrollment", "column": "enrollment_id"}}
    ],
    "table_type": "fact",
}
...
SCORE_DETAIL = {
    ...
    "foreign_key": [
        {"column": "score_id", "reference": {"table": "score", "column": "score_id"}}
    ],
    "table_type": "fact",
}
